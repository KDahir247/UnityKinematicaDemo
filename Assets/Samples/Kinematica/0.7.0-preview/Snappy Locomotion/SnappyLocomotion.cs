...
namespace SnappyLocomotion
{
	...
	public class SnappyLocomotion : MonoBehaviour
	{
		...
		private Unity.Kinematica.Identifier<Trajectory> desiredTrajectory;

		private Kinematica kinematica;


		private Unity.Kinematica.Identifier<SelectorTask> locomotion;

		private float3 movementDirection = Vector3.forward;
		...
		public virtual void OnAnimatorMove()
		{
			if (kinematica.Synthesizer.IsValid)
			{
				...
				var rootDelta = synthesizer.SteerRootMotion(desiredTrajectory,
				...
				#if UNITY_EDITOR
				if (Debugger.instance.rewind) return;
				#endif
